        ...
        <div class="section">
          ...
          <div class="card-list">
            ${0===e.length?W`<div class="no-cards">
                  No todo lists added yet. Click "+ ADD TODO LIST" below to add your first list.
                </div>`:e.map((t,i)=>{const o=this.Be(t),n=this.xe.has(i),r=this.ri(i);return W`
                    <div
                    ...
                    >
                      ...
                      <div class="card-actions" @click=${this.li}>
                        <ha-icon-button
                          label="Move Up"
                          ?disabled=${0===i}
                          path="M7,15L12,10L17,15H7Z"
                          @click=${t=>this.di(t,()=>this.Fe(i,-1))}
                        ></ha-icon-button>
                        <ha-icon-button
                          label="Move Down"
